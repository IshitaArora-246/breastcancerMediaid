...
def predict():
    ...
    if(int(result)==1):
        prediction = "Sorry you have chances of getting the Breast Cancer. Please consult the doctor immediately"
    else:
        prediction = "No need to fear. You have no dangerous symptoms of the Breast Cancer"
